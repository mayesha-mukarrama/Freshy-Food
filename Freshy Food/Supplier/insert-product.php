...
if(isset($_POST['submit']))
{
 ...
 $sql=mysql_query("insert into products (product_cat,product_title,product_brand,product_price,product_desc,product_image,product_keywords) values ('$category','$productname','$productcompany','$productprice','$productdescription','$productimage1','$productname')");
...
<head>
	...
	<title>Supplier| Insert Product</title>
...
<div class="controls">
<select name="productCompany" class="span8 tip" onChange="getSubcat(this.value);"  required>
