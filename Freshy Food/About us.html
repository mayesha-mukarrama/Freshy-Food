	...
	<div class="card">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li style="left:10px;top:5px; bottom: 10px"><button class="btn btn-primary" id="search_btn">Search</button></li>
			</ul>
...
<section class="engine"><a href="https://mobiri.se/i">free web creation software</a></section><section class="accordion2 cid-r14yTIKd84" id="accordion2-f">
        ...
        <div class="media-container-row pt-5">
            <div class="accordion-content">
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-5"><font size="5"><strong><br></strong><strong>Why Choose freshyfood</strong></h1>
                <br>
                ...
                <div id="bootstrap-accordion_0" class="panel-group accordionStyles accordion pt-5 mt-3" role="tablist" aria-multiselectable="true">
                        <div class="card">
                            <div class="card-header" role="tab" id="headingOne">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-core="" href="#collapse1_0" aria-expanded="false" aria-controls="collapse1">
                                    <h4 class="mbr-fonts-style display-5">
                                        <span class="sign mbr-iconfont mbri-arrow-down inactive"></span>&nbsp;Fresh</h4>
                                </a>
                            </div>
                            <div id="collapse1_0" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#bootstrap-accordion_0">
                                <div class="panel-body p-4">
                                    <p class="mbr-fonts-style panel-text display-7"><font size="3">All the fruits are fresh. We deliver you directly from the Tree,...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingTwo">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-core="" href="#collapse2_0" aria-expanded="false" aria-controls="collapse2">
                                    <h4 class="mbr-fonts-style mbr-fonts-style display-5">
                                        <span class="sign mbr-iconfont mbri-arrow-down inactive"></span>&nbsp;Organic</h4>
                                </a>
                            ...
                            <div id="collapse2_0" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#bootstrap-accordion_0">
                                <div class="panel-body p-4">
                                    <p class="mbr-fonts-style panel-text display-7"><font size="3">All the fruits are quality based. Chemical free....</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingThree">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-core="" href="#collapse3_0" aria-expanded="false" aria-controls="collapse3">
                                    <h4 class="mbr-fonts-style display-5">
                                        <span class="sign mbr-iconfont mbri-arrow-down inactive"></span>&nbsp;Low Price</h4>
                                </a>
                            </div>
                            <div id="collapse3_0" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#bootstrap-accordion_0">
                                <div class="panel-body p-4">
                                    <p class="mbr-fonts-style panel-text display-7"><font size="3">We deliver you with low price so that you can afford.</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-12">
            <div class="media-container-row">
                ...
                <div class=" align-left aside-content">
                    <h2 class="mbr-title pt-2 mbr-fonts-style display-2"><strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Our Story</strong></h2>
              ...
              We are Student.We start our business along with 7 people. We offer fresh food for customer with lower price so that they can afford.Our aim is to supply fresh and chemical free fruit. We have formalin detecter so that there is no doubt about the quality of the fruit. You can see the live formalin detection in front of you.
                    </h4>
                                </div>
                            </div>                
