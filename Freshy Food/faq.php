...
<section class="cd-faq">
	...
	<div class="cd-faq-items">
		<ul id="basics" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">How does the site work?</a>
				<div class="cd-faq-content">
					<p>You can browse the site or use our search engine to find your desired products. You can then add them to your shopping cart and click on place order. You let us know your address you are done.  A Freshy Food representative will then deliver your order right to your home or office.</p>
				</div> <!-- cd-faq-content -->
			</li>
